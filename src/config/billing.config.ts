...
export const BILLING_CONFIG = {
  ...
  SUPABASE_SERVICE_ROLE_KEY:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ4aGxyZW5tc2J5dHR4aGJ6a2d5Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MzAyNzQ2MSwiZXhwIjoyMDc4NjAzNDYxfQ.LXFfCrwv0qet9k51XDoBn8J5ZkQ79qcxBfr1MSRw_JY',
  ...
  // Upload constraints
  UPLOAD_MAX_MB: 2,
  UPLOAD_ALLOWED_MIME: ['image/jpeg', 'image/png', 'image/webp'] as const,
